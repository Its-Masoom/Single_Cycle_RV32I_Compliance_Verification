...
class moon(pluginTemplate):
    ...
    def __init__(self, *args, **kwargs):
        ...
        if config is None:
            ...
            raise SystemExit(1)
        self.dut_exe = os.path.join(config['PATH'] if 'PATH' in config else "","moon")
    ...
    def initialise(self, suite, work_dir, archtest_env):
        ...
        self.simulate = 'vsim -c -do "run -all" TopLevel_tb +sig={0}/DUT-moon.signature +mem_init={0}/dut.hex'
